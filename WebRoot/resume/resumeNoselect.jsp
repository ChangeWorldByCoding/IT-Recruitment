...
<body>
	               ...
	               <table class="table">
							...
							<tbody>
							   <c:forEach items="${resumeList0}" var="resumeList0" varStatus="resume">
								<tr class="danger">
									<td>${resume.count}</td>
									<td>${resumeList0.uid}</td>
									<td>${resumeList0.userName}</td>
									<td><a href="dowloadResume?fileName=${resumeList0.fileName}">${resumeList0.fileName}</a></td>
								</tr>
								</c:forEach>
