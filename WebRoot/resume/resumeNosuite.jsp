...
<html>
  ...
  <body>
           	...
           	<table class="table">
							...
							<tbody>
							   <c:forEach items="${resumeList3}" var="resumeList3" varStatus="resume">
								<tr class="danger">
									<td>${resume.count}</td>
									<td>${resumeList3.uid}</td>
									<td>${resumeList3.userName}</td>
									<td><a href="dowloadResume?fileName=${resumeList3.fileName}">${resumeList3.fileName}</a></td>
								</tr>
								</c:forEach>
